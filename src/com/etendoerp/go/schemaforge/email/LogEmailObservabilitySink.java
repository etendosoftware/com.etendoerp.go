...
final class LogEmailObservabilitySink implements EmailObservabilitySink {
  ...
  public void emit(EmailObservabilityEvent event) {
    ...
    log.log(level(event),
        "event=email_contract metrics=\"{}\" status=\"{}\" httpStatus={} contract=\"{}\" "
            + "version=\"{}\" tenantId=\"{}\" userId=\"{}\" recordId=\"{}\" "
            + "template=\"{}\" recipientDomain=\"{}\" recipientHash=\"{}\" "
            + "providerStatus={} duplicate={} throttleScope=\"{}\" killSwitchScope=\"{}\" "
            + "errorClass=\"{}\" durationMs={} providerDurationMs={}",
