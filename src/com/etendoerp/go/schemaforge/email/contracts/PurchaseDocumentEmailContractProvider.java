...
/**
 * Provides purchase document email contracts (purchase order and return to vendor).
 */
@ApplicationScoped
public final class PurchaseDocumentEmailContractProvider implements EmailContractProvider {

  @Override
  public Collection<EmailContract> getContracts() {
    return Arrays.asList(
        new PurchaseOrderSendEmailContract(new DalPurchaseOrderEmailDocumentResolver(
            DalPurchaseOrderEmailDocumentResolver.PurchaseOrderDocumentFamily.PURCHASE_ORDER)),
        new ReturnToVendorSendEmailContract(new DalPurchaseOrderEmailDocumentResolver(
