...
public final class DocumentDownloadTokenService {
  ...
  public static final long DEFAULT_TOKEN_TTL_SECONDS = TimeUnit.DAYS.toSeconds(7);
  ...
  public static Optional<String> createDownloadLink(String contractName, String specName,
    ...
    String token = createToken(contractName, specName, recordId, clientId, idempotencyKey,
        currentTimeSeconds() + tokenTtlSeconds(), secret);
  ...
  static String createToken(String contractName, String specName, String recordId,
    ...
    return createToken(contractName, specName, recordId, clientId, idempotencyKey,
        expiresAtSeconds, readRequiredSecret());
  }

  private static String createToken(String contractName, String specName, String recordId,
      String clientId, String idempotencyKey, long expiresAtSeconds, String secret) {
    try {
