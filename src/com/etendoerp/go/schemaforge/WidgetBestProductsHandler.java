...
public class WidgetBestProductsHandler implements NeoHandler {
  ...
  public NeoResponse handle(NeoContext context) {
    ...
    // rather than a 403 (see WidgetAccessPolicy): the matrix grants this to all five roles, including Purchasing and Inventory, which have no sales-invoice access.
    Role role = WidgetAccessPolicy.currentRole();
    if (!WidgetAccessPolicy.canRead(role, WidgetAccessPolicy.WINDOW_PRODUCT)) {
