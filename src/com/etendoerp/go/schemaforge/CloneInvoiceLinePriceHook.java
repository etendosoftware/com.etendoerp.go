...
public class CloneInvoiceLinePriceHook extends CloneRecordHook {
  ...
  public BaseOBObject postCopy(BaseOBObject originalRecord, BaseOBObject newRecord) throws Exception {
    ...
    // TODO (GREEN phase, ETP-4801): restore listPrice on each cloned InvoiceLine to match
    // the corresponding source line — the core CloneInvoiceHook resets it to the catalog price.
  }
}
