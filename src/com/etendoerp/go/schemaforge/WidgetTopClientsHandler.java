...
public class WidgetTopClientsHandler implements NeoHandler {
  ...
  public NeoResponse handle(NeoContext context) {
    ...
    // rather than a 403 (see WidgetAccessPolicy): ranked by invoiced sales — the data origin, not the contacts window the rows link to, which Purchasing also holds.
