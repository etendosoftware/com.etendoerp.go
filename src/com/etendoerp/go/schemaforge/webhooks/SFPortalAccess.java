 ...
 * ships in the MVP and why it is not behind either gate of plan §2.5: a tenant must be able to kill
 * a link that is already out, whatever the flag says. The flag decides whether NEW links go out, not
