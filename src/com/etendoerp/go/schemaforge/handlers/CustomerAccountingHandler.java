...
/**
 * NeoHandler for the {@code customerAccounting} entity in the Contacts window.
 *
 ...
 *
 * <p>Registered via {@code JAVA_QUALIFIER = 'customerAccountingHandler'} on
 * the ETGO_SF_ENTITY record for the customer accounting tab.
 */
@Named("customerAccountingHandler")
public class CustomerAccountingHandler implements NeoHandler {

  private static final Logger log = LogManager.getLogger(CustomerAccountingHandler.class);
  ...
  public NeoResponse handle(NeoContext context) {
    ...
    try {
      ...
      if (schemaId != null) {
        ...
        log.debug("Auto-filled accountingSchema={} for customer accounting line", schemaId);
      }
    } catch (Exception e) {
      log.warn("Could not auto-fill accountingSchema for customer accounting line", e);
    }
