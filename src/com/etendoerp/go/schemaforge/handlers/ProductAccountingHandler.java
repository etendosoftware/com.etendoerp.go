...
public class ProductAccountingHandler implements NeoHandler {

  private static final Logger log = LogManager.getLogger(ProductAccountingHandler.class);
  ...
  public NeoResponse handle(NeoContext context) {
    ...
    try {
      ...
      if (schemaId != null) {
        ...
        log.debug("Auto-filled accountingSchema={} for product accounting line", schemaId);
      }
    } catch (Exception e) {
      log.warn("Could not auto-fill accountingSchema for product accounting line", e);
    }
