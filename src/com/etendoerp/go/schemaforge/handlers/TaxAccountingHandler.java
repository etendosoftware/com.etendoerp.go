...
/**
 * NeoHandler for the {@code accounting} entity in the Tax window.
 *
 ...
 *
 * <p>Registered via {@code JAVA_QUALIFIER = 'taxAccountingHandler'} on
 * the ETGO_SF_ENTITY record for the tax accounting tab.
 */
@Named("taxAccountingHandler")
public class TaxAccountingHandler implements NeoHandler {

  private static final Logger log = LogManager.getLogger(TaxAccountingHandler.class);
  ...
  public NeoResponse handle(NeoContext context) {
    ...
    try {
      ...
      if (schemaId != null) {
        ...
        log.debug("Auto-filled accountingSchema={} for tax accounting line", schemaId);
      }
    } catch (Exception e) {
      log.warn("Could not auto-fill accountingSchema for tax accounting line", e);
    }
