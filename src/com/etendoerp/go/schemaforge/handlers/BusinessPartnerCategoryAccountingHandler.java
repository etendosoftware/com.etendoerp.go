...
public class BusinessPartnerCategoryAccountingHandler implements NeoHandler {

  private static final Logger log = LogManager.getLogger(BusinessPartnerCategoryAccountingHandler.class);
  ...
  public NeoResponse handle(NeoContext context) {
    ...
    try {
      ...
      if (schemaId != null) {
        ...
        log.debug("Auto-filled accountingSchema={} for business partner category accounting line",
            schemaId);
      }
    } catch (Exception e) {
      log.warn("Could not auto-fill accountingSchema for business partner category accounting line", e);
    }
