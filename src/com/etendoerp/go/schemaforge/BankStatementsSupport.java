...
public final class BankStatementsSupport {
  ...
  /** Formats a timestamp as an ISO-8601 UTC instant, or {@code ""} when {@code null}. */
  ...
  /**
   * Parses an ISO-8601 instant (e.g. {@code 2026-06-04T00:00:00Z}); returns
   * {@code fallback} on blank or invalid input.
   */
