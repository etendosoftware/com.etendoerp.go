...
public class McpToolRouter {
   ...
   */
  private JSONObject runTablessReadHook(String specName, String entityName, String recordId,
   ...
   */
  private static Map<String, String> buildReadHookParams(JSONObject filters, String parentId,
  ...
  private JSONObject handleList(String specName, JSONObject args) throws Exception {
    ...
    JSONObject handled = runTablessReadHook(specName, entityName, null, sfEntity,
        buildReadHookParams(filters, parentId, offset, limit, orderBy));
    if (handled != null) {
      return handled;
    }
  ...
  private JSONObject handleGet(String specName, JSONObject args) throws Exception {
    ...
    // ETP-5405: see runTablessReadHook — the handler answers before the tab is demanded.
    JSONObject handled = runTablessReadHook(specName, entityName, recordId, sfEntity,
        buildReadHookParams(null, null, null, null, null));
    if (handled != null) {
      return handled;
    }
