...
public class OnboardingBaselineService {
   ...
   *
   * Current watermark: R11 acctschema-default-completion (2026-07-06).
   *
   ...
   */
  private static final Instant ONBOARDING_PROVISIONED_THROUGH = Instant.parse("2026-07-06T16:00:00Z");
