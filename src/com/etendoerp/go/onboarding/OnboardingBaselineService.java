...
public class OnboardingBaselineService {
   ...
   *
   * Current watermark: R12 writeoff-account-override (2026-07-08).
   *
   ...
   */
  private static final Instant ONBOARDING_PROVISIONED_THROUGH = Instant.parse("2026-07-08T09:00:00Z");
