...
/**
 * ETP-5378 — posting delegation for {@link ReturnToVendorShipmentHeaderHandler}.
 *
...
public class ReturnToVendorShipmentHeaderHandlerPostingTest {
  ...
  public void handleReturnsPostingResponseWhenServiceHandlesAction() {
    ...
    ReturnToVendorShipmentHeaderHandler handler = new ReturnToVendorShipmentHeaderHandler();
