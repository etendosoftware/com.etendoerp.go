...
public class SelectorContextParamsTest {
  ...
  public void testBuildSelectorContextParamsMapsBusinessPartner() throws Exception {
    ...
    Map<String, String> result = router.buildSelectorContextParams(args, null);
  ...
  public void testBuildSelectorContextParamsDerivesIsSOTrxFromSalesTab() throws Exception {
    ...
    Map<String, String> result = router.buildSelectorContextParams(args, salesTab);
  ...
  public void testBuildSelectorContextParamsDerivesIsSOTrxFromPurchaseTab() throws Exception {
    ...
    Map<String, String> result = router.buildSelectorContextParams(args, purchaseTab);
  ...
  public void testCopyContextIfPresentCopiesValue() throws Exception {
    ...
    router.copyContextIfPresent(recordContext, "sourceKey", target, "targetKey");
  ...
  public void testCopyContextIfPresentSkipsMissingKey() throws Exception {
    ...
    router.copyContextIfPresent(recordContext, "missingKey", target, "targetKey");
  ...
  public void testDiagnosticsSuggestsBPartnerForLocationSelector() throws Exception {
    ...
    JSONObject result = router.neoResponseToMcpResultWithDiagnostics(response,
        "C_BPartner_Location_ID", contextParams);

    assertNotNull(result);
    JSONObject content = result.getJSONArray("content").getJSONObject(0);
    JSONObject responseBody = new JSONObject(content.getString("text"));
    ...
    JSONObject missing = findMissingContext(missingContext, "C_BPartner_ID");
  ...
  private JSONObject findMissingContext(JSONArray missingContext, String param) throws Exception {
    for (int i = 0; i < missingContext.length(); i++) {
      JSONObject missing = missingContext.getJSONObject(i);
      if (param.equals(missing.optString("param"))) {
        return missing;
      }
    }
    return null;
